      ...
      <div className="bg-white rounded-2xl shadow-md w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
          <div>
            ...
            />
            {errors.email && <p className="text-indigo-500 text-xs mt-1">{(errors.email as any).message}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-400"
            />
            {errors.password && <p className="text-indigo-500 text-xs mt-1">{(errors.password as any).message}</p>}
          </div>
